...
- (id)initWithAppKey:(NSString *)appKey appSecret:(NSString *)appSecret text:(NSString *)text image:(UIImage *)image
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        [panelImageView setImage:[[UIImage imageNamed:@"ShareKit.bundle/bg.png"] stretchableImageWithLeftCapWidth:18 topCapHeight:18]];
		...
		[closeButton setBackgroundImage:[UIImage imageNamed:@"ShareKit.bundle/btn.png"] forState:UIControlStateNormal];
		...
		[sendButton setBackgroundImage:[UIImage imageNamed:@"ShareKit.bundle/btn.png"] forState:UIControlStateNormal];
		...
		[clearTextButton setContentMode:UIViewContentModeCenter];
 		[clearTextButton setImage:[UIImage imageNamed:@"ShareKit.bundle/delete.png"] forState:UIControlStateNormal];
        ...
        if (image)
        {
			...
			[clearImageButton setImage:[UIImage imageNamed:@"ShareKit.bundle/close.png"] forState:UIControlStateNormal];
...
- (void)onSendButtonTouched:(id)sender
{
    ...
    self.hud.customView = [[[UIView alloc] init] autorelease];
    self.hud.mode = MBProgressHUDModeCustomView;
    self.hud.labelText=@"发送中...";
    //self.hud.detailsLabelText = @"There might be a network issue, please try again later.";
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    if (UIInterfaceOrientationIsLandscape(orientation))
    {
        ...
        [panelImageView setImage:[UIImage imageNamed:@"ShareKit.bundle/bg_land.png"]];
    ...
    else
    {
        ...
        [panelImageView setImage:[UIImage imageNamed:@"ShareKit.bundle/bg.png"]];
